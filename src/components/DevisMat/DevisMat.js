...
export const DevisMat = () => {
    ...
    const DevisMatModifyQuery = useModifyDevisMat();
    ...
    const deleteProduct = async (e) => {
        ...
        try {
            await DevisMatDeleteByIdQuery.mutateAsync(product.id);
            history.push({
                pathname: "/DevisMat",
            });
            setProducts(products);
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    {DevisMatsQuery.isIdle || DevisMatsQuery.isLoading ? (
                        <>
                            {[1, 2, 3, 4].map((n) => (
                                <DataTable value={products} className="p-datatable-striped">
                                    <Column selectionMode="multiple" headerStyle={{ width: "3rem" }}></Column>
                                    <Column field="code" header="Nom de Devis" sortable body={skeletonTemplate} headerStyle={{ width: "20%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                        ...
                        >
                            <Column selectionMode="multiple" headerStyle={{ width: "3rem" }}></Column>
                            <Column field="code" header="Nom de Devis" sortable body={codeBodyTemplate} headerStyle={{ width: "20%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                    ...
                    <Dialog visible={productDialog} style={{ width: "450px" }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            <label htmlFor="Quantités">Quantités</label>
                            <InputText id="Quantités" value={product.qts} onChange={(e) => onInputChange(e, "qts")} required autoFocus className={classNames({ "p-invalid": submitted && !product.qts })} />
                            {/* {submitted && !product.name && <small className="p-invalid">Name is required.</small>} */}
                        </div>
                        <div className="field">
