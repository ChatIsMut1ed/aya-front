...
import { useUser, useUserById, useDeleteUserById, useCreateUser, useModifyUser } from "../../Hooks/api/user.api";
import { useAuthDispatch } from "../../stores/auth.store.js";

export const User = () => {
    // work
    const usersQuery = useUser();
    const userByIdQuery = useUserById();
    const userDeleteByIdQuery = useDeleteUserById();
    const userCreateQuery = useCreateUser();
    const userModifyQuery = useModifyUser();
    ...
    const saveProduct = async (e) => {
        ...
        if (product.id == null) {
            try {
                await userCreateQuery.mutateAsync(formData);
                history.push({
                    pathname: "/User",
                });
            ...
            try {
                await userModifyQuery.mutateAsync(formData);
                history.push({
                    pathname: "/User",
                });
                setProducts(products);
    ...
    const deleteProduct = async (e) => {
        ...
        try {
            await userDeleteByIdQuery.mutateAsync(product.id);
            history.push({
                pathname: "/User",
            });
            setProducts(products);
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    {usersQuery.isIdle || usersQuery.isLoading ? (
                        <>
                            {[1, 2, 3, 4].map((n) => (
                                <DataTable value={products} className="p-datatable-striped">
                                    <Column selectionMode="multiple" headerStyle={{ width: "3rem" }}></Column>
                                    <Column field="code" header="Nom" sortable body={skeletonTemplate} headerStyle={{ width: "14%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                                    <Column field="name" header="Prenom" sortable body={skeletonTemplate} headerStyle={{ width: "14%", minWidth: "10rem" }} className="bg-indigo-300 border-round-top"></Column>
                                    <Column field="price" header="CIN" body={skeletonTemplate} sortable headerStyle={{ width: "14%", minWidth: "8rem" }} className="bg-pink-200 border-round-top"></Column>
                                    <Column header="Email" body={skeletonTemplate} headerStyle={{ width: "14%", minWidth: "10rem" }} className="bg-green-300 border-round-top"></Column>
                                    <Column field="Tel" header="Tel" body={skeletonTemplate} sortable headerStyle={{ width: "14%", minWidth: "8rem" }} className="bg-pink-200 border-round-top"></Column>
                                    <Column field="category" header="Mot de passe" sortable body={skeletonTemplate} headerStyle={{ width: "14%", minWidth: "10rem" }} className="bg-gray-500 border-round-top"></Column>
                                    <Column field="rating" header="Adresse" body={skeletonTemplate} sortable headerStyle={{ width: "14%", minWidth: "10rem" }} className="bg-pink-100 border-round-top"></Column>
                                    <Column field="name" header="Type" sortable body={skeletonTemplate} headerStyle={{ width: "14%", minWidth: "10rem" }} className="bg-indigo-300 border-round-top"></Column>
                    ...
                    <Dialog visible={productDialog} style={{ width: "450px" }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <InputText id="Prenom" value={product.surname} onChange={(e) => onInputChange(e, "surname")} required autoFocus className={classNames({ "p-invalid": submitted && !product.surname })} />
                            {/* {submitted && !product.name && <small className="p-invalid">Name is required.</small>} */}
                        </div>
                        <div className="field">
                        ...
                        <div className="field">
                            ...
                            <InputText id="mdp" value={product.password} onChange={(e) => onInputChange(e, "password")} required autoFocus className={classNames({ "p-invalid": submitted && !product.password })} />
                            {/* {submitted && !product.name && <small className="p-invalid">Name is required.</small>} */}
                        </div>
                        <div className="field">
                        ...
                        <div className="field">
                            ...
                            <InputText id="Type" value={product.type} onChange={(e) => onInputChange(e, "type")} required autoFocus className={classNames({ "p-invalid": submitted && !product.type })} />
                            {/* {submitted && !product.name && <small className="p-invalid">Name is required.</small>} */}
                        </div>
                    </Dialog>
                    <Dialog visible={factureDialog} style={{ width: "450px" }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        {userByIdQuery.isIdle || userByIdQuery.isLoading ? (
                            <>
                                <skeletonTemplate />
                            </>
                        ) : userByIdQuery.isSuccess ? (
                            ""
                        ) : (
                            ""
                        )}
