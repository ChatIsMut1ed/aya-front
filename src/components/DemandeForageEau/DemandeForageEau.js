            ...
            <div className="col-12">
                <div className="card">
                    ...
                    {SolsQuery.isIdle || SolsQuery.isLoading ? (
                        <>
                            {[1, 2, 3, 4].map((n) => (
                                <DataTable value={products} className="p-datatable-striped">
                                    ...
                                    <Column field="code" header="Nom" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                                    <Column field="name" header="Prenom" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-indigo-300 border-round-top"></Column>
                                    <Column field="price" header="Adresse" body={skeletonTemplate} sortable headerStyle={{ width: "8%", minWidth: "8rem" }} className="bg-pink-200 border-round-top"></Column>
                                    <Column header="CIN" body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-green-300 border-round-top"></Column>
                                    <Column field="Date" header="Num_Frais_IM" body={skeletonTemplate} sortable headerStyle={{ width: "8%", minWidth: "8rem" }} className="bg-pink-200 border-round-top"></Column>
                                    <Column field="Date_De_Disposition" header="Localisation" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                                    <Column field="name" header="Tel" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-indigo-300 border-round-top"></Column>
                                    ...
                                    <Column header="gouvernorat" body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-green-300 border-round-top"></Column>
                                    <Column field="code" header="Superficie" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "8rem" }} className="bg-cyan-400 border-round-top"></Column>
                                    <Column field="name" header="Type_de_Projet" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-indigo-300 border-round-top"></Column>
                                    <Column field="price" header="Remarques" body={skeletonTemplate} sortable headerStyle={{ width: "8%", minWidth: "8rem" }} className="bg-pink-200 border-round-top"></Column>
                                    <Column field="Date_De_Disposition" header="Types_de_Plantes" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                                    <Column field="Date" header="Signature" body={skeletonTemplate} sortable headerStyle={{ width: "8%", minWidth: "8rem" }} className="bg-pink-200 border-round-top"></Column>
                                    <Column field="Date_De_Disposition" header="Types_de_signature" sortable body={skeletonTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
                        ...
                        >
                            <Column selectionMode="multiple" headerStyle={{ width: "3rem" }}></Column>
                            <Column field="code" header="Nom" sortable body={codeBodyTemplate} headerStyle={{ width: "8%", minWidth: "10rem" }} className="bg-cyan-400 border-round-top"></Column>
